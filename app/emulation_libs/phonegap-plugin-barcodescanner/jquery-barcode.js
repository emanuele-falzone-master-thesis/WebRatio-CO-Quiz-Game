...
(function ($) {
  ...
  var barcode = {
    ...
    digitToBmpRenderer: function($container, settings, digit, hri, mw, mh){
      ...
      return 'data:image/bmp;base64,'+ this.base64Encode(bmp);                 
    },
    // bmp 1D barcode renderer
    digitToBmp: function($container, settings, digit, hri){
      var w = barcode.intval(settings.barWidth);
      var h = barcode.intval(settings.barHeight);
      return this.digitToBmpRenderer(null, settings, this.bitStringTo2DArray(digit), hri, w, h);
    },
  ...
  $.fn.extend({
    barcode: function(datas, type, settings) {
      ...
      return barcode['digitToBmp'](null, settings, digit, hri);
    }
  });
